        ...
        >
            ...
            <motion.div variants={fadeUp}>
                <div className="flex items-center justify-between mb-2">
                    <label className="font-mono font-bold text-xs uppercase text-ink/70">
                        Password
                    </label>
                    <button
                        type="button"
                        onClick={onForgotPassword}
                        className="font-mono text-xs text-ink/50 hover:text-[#3b82f6] underline underline-offset-2 transition-colors cursor-pointer"
                    >
                        Forgot password?
                    </button>
                </div>
            ...
            <motion.div variants={fadeUp}>
                <label className="flex items-center gap-2 cursor-pointer group">
                    <input
                        ...
                        className="w-4 h-4 border-2 border-ink/20 accent-primary cursor-pointer"
                    />
                    <span className="font-mono text-xs text-ink/60 group-hover:text-ink transition-colors">
                        Remember me
                    </span>
                </label>
            </motion.div>
            ...
            <motion.div variants={fadeUp}>
                ...
                >
                    {loading ? <Spinner /> : <LogIn className="w-5 h-5" />}
